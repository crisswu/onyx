...
# agent is forced to answer. Default 10 gives tool-heavy chats more room while
# still bounding runaway loops; override via env when needed.
MAX_LLM_CYCLES: int = int(os.environ.get("MAX_LLM_CYCLES") or 10)
